...
## Installation
Simply clone or download this repo, and add it to your MATLAB path:
```matlab
...
This file has been generated by executing the following command provided by the [Dependency Manager for MATLAB](https://github.com/CarmVarriale/DependencyManager) by Carmine Varriale.
```matlab
DependencyManager.writeDeps(DependencyManager.findDeps("./@TreeNode/*.m"));
```
